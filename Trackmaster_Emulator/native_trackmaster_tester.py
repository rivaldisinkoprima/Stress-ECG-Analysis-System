...
def print_banner():
    ...
    print("=" * 60)
    print(" 🚀 TRACKMASTER FULL-NATIVE TREADMILL CONTROLLER")
...
def main():
    ...
    print_banner()
    print("Aplikasi ini berinteraksi LANGSUNG dengan protokol Trackmaster")
    print("tanpa menggunakan DrvtTrackMaster.dll.\n")
    ...
    try:
        ...
        # Mematikan kontrol DTR/RTS bawaan PySerial agar tidak bentrok dengan driver kabel clone (CH340/PL2303)
        ser = serial.Serial(
            port=port_name,
            baudrate=4800,
        ...
        print("    3. Jika 'Access is denied', matikan aplikasi lain yang sedang menahan COM port ini.")
        return
